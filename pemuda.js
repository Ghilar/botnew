...
const isAntiVO = isGroup ? antiviewonce.includes(from) : false	
		...
		const katalog = (teks) => {
             res = pemuda.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "© Eroze Botz", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             pemuda.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = pemuda.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `${NamaBot}`, "footerText": "© Eroze Botz", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
pemuda.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "© Eroze Botz", [{buttonId: 'simi', buttonText: {disText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
	...
	//•======>> SUBSCRIBE : PEMUDA TEKNOLOGI <<====•\\
        ...
        const sendWebp = async(from, url) => {
	        ...
	        pemuda.sendMessage(from, { disname: nama, vcard: vcard}, MessageType.contact, {contextInfo: {"mentionedJid": ane}})
				...
				const reply = (teks) => {
			pemuda.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title:`Hai ${pushname}`,body:"",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/628985397156?text=Assalamualaikum%20Kakak%20Rokhis%20yang%20Ganteng`}}})
		}
		const simir = (teks) => {
...
case 'sewa':
       ...
       menu = `0`
sendButLocation(from, `*_Hai ${pushname} 👋🏻_* \n\nyakin nih mau sewa bot ? 🤔 Boong auto banned >_<`, "*Eroze Botz*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}sewa1`,buttonText:{displayText:'🗿Ya'},type:1},{buttonId:`${prefix}gk`,buttonText:{displayText:'👀Tidak'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'sewa1':
 listMsg = {
...
case '🕔sewa':
       ...
       menu = `0`
sendButLocation(from, `_*Hai ${pushname}🌹*_\n\nSilahkan pilih metode pembayaran`, "*Eroze Botz*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}py`,buttonText:{displayText:'NOMOR 📱'},type:1},{buttonId:`${prefix}qrsewa`,buttonText:{displayText:'QR CODE 📱'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'py':
        case '0':
        stod = `${sender}`
       ...
       menu = `0`
sendButLocation(from, `_*Hai ${pushname}🌹*_\n\nSilahkan pilih metode pembayaran`, "*Eroze Botz*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}o1`,buttonText:{displayText:'OVO 📱'},type:1},{buttonId:`${prefix}d1`,buttonText:{displayText:'GOPAY 📱'},type:1},{buttonId:`${prefix}d1`,buttonText:{displayText:'DANA 📱'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'qrsewa':
        case '0':
        stod = `${sender}`
       ...
       menu = `0`
sendButLocation(from, `_Hai ${pushname}🌹_\n\nSilahkan pilih metode pembayaran`, "*Eroze Botz*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}qrg1`,buttonText:{displayText:'QR GOPAY 📱'},type:1},{buttonId:`${prefix}qro1`,buttonText:{displayText:'QR OVO 📱'},type:1},{buttonId:`${prefix}qrd1`,buttonText:{displayText:'QR DANA 📱'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'qro1':
...
case 'sewaff2':
       ...
       menu = `0`
sendButLocation(from, `_Hai ${pushname}_\n\nSilahkan pilih metode pembayaran`, "Eroze Botz*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}sewa2`,buttonText:{displayText:'💞Ya'},type:1},{buttonId:`${prefix}gk`,buttonText:{displayText:'👀Tidak'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
///===== PEMBATAS SEWA ====\\\
//// PEMBATAS MENU OWNER \\\
case 'ban':
...
const btnbc = {
    ...
    footerText: 'Broadcast Eroze Botz',
    buttons: buttons,
    headerType: 1
}
...
case 'ppcp': 
   ...
   sendButImage(from, pll, `Eroze Botz © 2021`, cewe, [                      
          {
...
pemuda.sendMessage(from, goo, image, {quoted: fvid, caption: 'Nih Jangan Lupa Subscribe Eroze Botz'})
break
case 'cecanrandom':
...
- Hari : ${week} ${weton}
- Tanggal : ${calender}`
sendButLocation(from,  `${menu}`, `${uwu}© Eroze Botz ${uwu}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}script2`,buttonText:{displayText:'SCRIPT🔥'},type:1}, {buttonId:`${prefix}owner`,buttonText:{displayText:'OWNER👤'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
...
const kontil = body.slice(8)
                    ...
                    pemuda.sendMessage('628985397156@s.whatsapp.net', options, text, {quoted: mek})
